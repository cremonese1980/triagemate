...
class TriageNullPayloadTest extends KafkaIntegrationTestBase {
    ...
    @Test
    void nullPayload_validationFails_noDecisionEmitted() throws Exception {
        ...
        producer.send("triagemate.ingest.input-received.v1",
                UUID.randomUUID().toString(), envelope).get();
    ...
    private Consumer<String, String> decisionMadeConsumer() {
        ...
        String groupId = "triage-nullpayload-it-" + UUID.randomUUID();
